  ...
  render(_, context) {
    ...
    return (
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" {...props}>
        ...
        <path d="M15.5 11.8H9.4c-.3 0-.5-.2-.5-.5s.2-.5.5-.5h5l-1.1-1.1c-.2-.2-.2-.5 0-.7.1-.1.2-.1.3-.1s.3 0 .4.1l1.8 1.8c.1.2.2.3.2.5 0 .1 0 .3-.1.3-.1.1-.3.2-.4.2zm-6.1 1.3h6.1c.3 0 .5.2.5.5s-.2.4-.5.4h-5l1.1 1.1c.2.2.2.5 0 .7-.1.1-.2.2-.3.2-.2 0-.3-.1-.4-.1L9.1 14v-.1c-.1-.1-.2-.3-.1-.5 0-.2.2-.3.4-.3z" />
      </svg>
    );
  },
});

const SquareSwitchOutlined = {
  functional: true,
